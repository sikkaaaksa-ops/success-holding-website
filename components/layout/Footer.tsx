    ...
    <footer className="bg-brand-charcoal text-brand-gray">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            <h3 className="text-brand-white font-body text-sm uppercase tracking-wider mb-4">
              {t('quickLinks')}
            </h3>
              ...
              {NAV_ITEMS.map((item) => (
                <li key={item.key}>
                  <Link
                    ...
                    className="text-sm transition-colors duration-300 hover:text-brand-gold"
                  >
                    {nav(item.key)}
                  </Link>
                </li>
          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              <a
                ...
                aria-label="LinkedIn"
                className="text-brand-gray transition-colors duration-300 hover:text-brand-gold"
              >
                <LinkedInIcon />
              </a>
              <a
      ...
      {/* Bottom bar */}
      <div className="border-t border-brand-gray-dark/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-brand-gray">
